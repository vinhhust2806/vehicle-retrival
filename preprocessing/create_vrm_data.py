...
def msvd_format_data():
    ...
    txt_path = "/data/test-queries.json"
    txt_data = {}
    with open(txt_path, "r") as f:
        txt_data = json.load(f)
    print(len(txt_data))

    video_path = "/data/test-tracks.json"
    video_data = {}
    ...
    with open('/xclip/data/raw-captions.pkl', 'wb') as handle:
        pickle.dump(aicity_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)    
    
    with open('/xclip/data/train_list.txt', 'w') as f:
        f.write(train_list)
    with open('/xclip/data/val_list.txt', 'w') as f:
        f.write(val_list)
    with open('/xclip/data/test_list.txt', 'w') as f:
        f.write(test_list)
...
def msvd_format_data2():
    ...
    with open('/xclip/data/raw-captions2.pkl', 'wb') as handle:
        pickle.dump(aicity_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)    
